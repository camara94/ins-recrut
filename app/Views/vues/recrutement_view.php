...
<?php if (isset($_POST['projet'])): ?>
    ...
    <div class="<?php if($projet['id'] == 18){ echo" hidden"; } ?>">
        <div style="position:absolute;width:200px;color: black;font-size: 14px;font-weight: normal;margin-left:70px; padding:10px;background-color: #abc598;;margin-bottom: -45px;">
            EMAIL
        </div>
    </div>

    <div class="<?php if($projet['id'] == 18){ echo" hidden"; } ?>" style="width:645px; margin:auto; margin-top:5px; padding-top:10px; padding-bottom:20px;background-color:#f1f1f1; margin-bottom:20px">
        <div style="width: 500px; margin-left: 52px; margin-right: 52px">
            <div id="div_info_pers">
                <div>
                    <div class="top-30">
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-4 control-label text-bold">EMAIL <span
                                        style="color:red">(*)</span></label>
                            <div class="col-sm-8">
                                <input type="email" name="email" class="form-control" autocomplete="off" id="" placeholder="email">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="top-30">
						...
						*/
                        ...
                        ?>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-4 control-label text-bold">
                                <?= $labelOption ?> <span style="color:red">(*)</span>
                            </label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group <?php if($projet['id'] == 18 ||$projet['id'] == 19){ echo" hidden"; } ?>"> 
                        ...
                        <?php                            
                            $status = array(
                                ...
                                'SANS EMPLOI' => 'SANS EMPLOI - CHOMEUR',
                            );  
    ...
    <div>
        <div style="position:absolute;width:220px;color:black;font-size: 14px;font-weight: normal;margin-left:70px; padding:10px;background-color: #abc598;;margin-bottom: -45px;">            
            <?php 
                if($projet['id']==18){ echo "EXPERIENCE EN TANT QUE CHAUFFEUR"; }
                else{ echo"DERNIERE EXPERIENCE EN COLLECTE DE DONNEES"; }
            ?>
        </div>
    </div>
    ...
    <div style="width: 710px;margin:auto">
        <div class="" style="margin-top:90px">
              ...
              <div class="form-group">
                    ...
                    <?php 
                        if($projet['id']==18) echo "Avez vous une expérience en tant que chauffeur ?"; 
            ...
            <div class="col-xs-12">
                ...
                <table id="tab_exp" class="table display responsive nowrap" width="100%" cellspacing="0" style="">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td> 
                                <select name="fontion_1" id="fontion_1" class="form-control"> 
                            ...
                            <td>  
                                <select name="projet_name_1" id="projet_name_1" class="form-control"> 
                                    <option value="">Choisissez</option> 
                        ...
                        <tr>
                            <td colspan="4">
                                <div class="form-group">
                                    <label for="userFiles8" class="col-sm-4 control-label text-bold">JOINDRE UNE ATTESTATION (Facultatif)
                                        <span style="font-weight:500;"> Taille Maxi 2Mo en 
                                        <span style="color:re;">jpeg,png,jpg,pdf </span> 
                                        <!-- (<span style="color:re;">*</span>)</span> -->
                                    </label>
                                    <div class="col-sm-8">
                ...
                <table id="tab_exp" class="table display responsive nowrap" width="100%" cellspacing="0" style="">
                    ...
                    <tbody>
                        <tr>
                            <td><input type="text" name="employeur_1" class="form-control" /></td>                                                             
                            <td><input type="text" name="fontion_1" class="form-control" /></td>
                            <td><input type="text" name="projet_name_1" class="form-control" /></td>
                            <td> <select name="year_deb_1" placeholder="Ann&eacute;e" class="year form-control"></select> </td>     
                            <!--<td><a href="#" class="delete_exp">SUPPRIMER</a></td>-->
                        </tr>
                        ...
                        <tr>
                            <td colspan="4">
                                <div class="form-group">
                                    <label for="userFiles8" class="col-sm-4 control-label text-bold">JOINDRE UNE ATTESTATION (Si vous en disposez )
                                        <span style="font-weight:500;"> Taille Maxi 2Mo en 
                                        <span style="color:re;">jpeg,png,jpg,pdf </span> 
                                        <span style="color:re;"></span></span>
                                    </label>
        ...
        <div style="width: 500px; margin-left: 52px; margin-right: 52px">
            <div id="div_second_pers">
                ...
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label text-bold">                        
                        <?php
                            if($projet['id'] == 18){ echo"JOINDRE LA COPIE DU PERMIS DE CONDUIRE"; }
                            else if($projet['id'] == 19){ 
                                echo"JOINDRE <br />"; 
                        ...
                        ?>
                        <span style="font-weight:500;"> Taille Maxi 2Mo en </span>
                        <span style="color:red;">jpeg,png,jpg,pdf </span> (<span style="color:red;">*</span>)
                ...
                <div class="form-group <?php if($projet['id'] == 18 || $projet['id'] == 19){ echo" hidden"; } ?>">  
                    ...
                    <div class="col-sm-8">
                        <input type="file" name="userFiles2" class="form-control c_file_css" id="" <?php if($id_projet != 18){ if($id_projet != 19){echo" required";} } ?>>
                    </div>
                </div>               
