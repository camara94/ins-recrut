<div class="rigthContener">
    <?php if(isset($projet)):?>
        ...
        <div class="blink form-group top-30" style="text-align:center;color:red;font-weight: bold; text-decoration: blink">
            <span style="font-weight: 500; font-size:15px; ">NB : </span>
            Veuillez renseigner vos informations correctes, car elles seront verifiées. En cas de constat d'informations incorrectes, 
            votre candidature sera immédiatement rejetée. 
        </div> 
    <?php else: ?>
        <?php 
            echo "<div style='text-align:center;font-weight: bold'>Veuillez s&eacute;lectionner un projet en cliquant sur le lien : <a href='https://rgph.gov.gn'>ICI</a></div>"; 
        ?>
    <?php endif; ?>   
...
<script>
	...
	$.validator.addMethod('verifDateSignature',function(value, element, param){
		...
		if (yrAgt != 2024 || parseInt(d1s[1]) > 12 || parseInt(d1s[1]) < 1) {
            return false;
        } 
        else{
			return true;
    ...
    $("form.form_recrut").validate({
        ...
        messages: {
            ...
            date_naiss: {
				...
				// maxDate : "vous devez avoir moins de 55 ans pour postuler",
            ...
            date_jour_decla:{
				...
				verifDateFormat : "veuillez saisir une date correcte au format (JJ/MM/AAAA)",	
				verifDateSignature : "doit être la date du jour au format jj/mm/aaaa"
			},
            ...
            numero_cni:"Veuillez saisir le numéro de votre Carte d'identité National",
            ...
            userFiles4: {
                required: "Veuillez joindre une Carte d'identité National",
                extension: "La Carte d'identité National doit &ecirc;tre au format jpeg, png, jpg, pdf ",
                filesize: "La taille du fichier doit &ecirc;tre 2Mo Maxi"
            },
            userFiles5: {
                required: "Veuillez joindre la Carte d'identité National du tuteur legal",
                extension: "La Carte d'identité National doit &ecirc;tre au format jpeg, png, jpg, pdf ",
                filesize: "La taille du fichier doit &ecirc;tre 2Mo Maxi"
            },
            status: {
        ...
        $("#multiphase").children("div").steps({
            ...
            onStepChanging: function (event, currentIndex, newIndex)
            {
				...
				if(!form.valid()){
					$.alert({
                           title: 'Attention!',
                           content: "Veuillez renseigner tous les champs jusqu'en bas",
                        });
				}
                return form.valid();
            },
