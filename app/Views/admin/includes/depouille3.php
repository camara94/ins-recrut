                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="age121" name="age12" class="custom-control-input" value="0" <?php if($age < 18 || $age > 50) echo " checked"; ?> />
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="niv_etu1" name="niv_etu" class="custom-control-input"value="0">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="sp1" name="sp" class="custom-control-input" value="10">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="co_lg_carto_trait_img1" name="co_lg_carto_trait_img" class="custom-control-input" value="10">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="trav_carto_realise1" name="trav_carto_realise" class="custom-control-input"value="5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="dp_chauffeur18" name="dp_chauffeur18" class="custom-control-input" value="5">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="exp_chauffeur18" name="exp_chauffeur18" class="custom-control-input"  value="3" >
                                                    <label class="custom-control-label" for="exp_chauffeur18">Obtenu avant 2010 </label>
                                                </div>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="exp_chauffeur18_1" name="exp_chauffeur18" class="custom-control-input"  value="2" >
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="occ_ant" name="occ_ant" class="custom-control-input" value="3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="exp_collect17-1" name="exp_collect17" class="custom-control-input" value="0">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="utilis_tablette-1" name="utilis_tablette" class="custom-control-input"value="3">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="cons_informatique-1" name="cons_informatique" class="custom-control-input" value="5">
