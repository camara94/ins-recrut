...
<section class="dasbord_section">
    <div class="row">
        <div class="col-xl-12 col-md-12 col-12 dasbord_subbox">   
            <div class="right_amountbox">
                ...
                <div class="right_txtbox1">
                    <div class="user_box">  
                        <h4>Total Affecté aux Agents</h4>
                    </div>
                    <h5><?= $affecteAgents ?></h5>
                </div>
                <div class="right_txtbox2">
                    <div class="user_box">
                        <h4>Total Traité par les Agents</h4>
                    </div>
        ...
        <form class="col-12 mt-3" action="/index.php/trombinoscope" method="GET">
            <div class="row">
                        ...
                        <div class="row mb-1"> 
                            <div class="col"> 
                                ...
                                <div class="p-3 text-center">
                                    ...
                                    <?php }else{ ?>         
                                        <button class="btn btn-<?= $cl ?> btn-sm"> <i class="fa fa-check" aria-hidden="true"></i> <?= $clTxt ?>  </a>
                                    <?php } ?>
                                </div>
                            </div> 
                        </div>                              
