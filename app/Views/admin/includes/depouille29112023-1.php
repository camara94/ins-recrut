                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="age121" name="age12" class="custom-control-input" value="0" <?php if($age < 18 || $age > 50) echo " checked"; ?> required />
                                                    <label class="custom-control-label" for="age121">Moins de 18 ans ou 50 ans ou plus </label>
                                                </div>
                                                
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="age123" name="age12" class="custom-control-input" value="3" <?php if($age > 18 && $age <= 50) echo " checked"; ?> />
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="sp3" name="sp" class="custom-control-input" value="5">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="co_lg_carto_trait_img0" name="co_lg_carto_trait_img" class="custom-control-input" value="0"required>
                                                    <label class="custom-control-label" for="co_lg_carto_trait_img0"> Aucune Connaissance </label>
                                                </div>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="co_lg_carto_trait_img1" name="co_lg_carto_trait_img" class="custom-control-input" value="10"required>
                                                    <label class="custom-control-label" for="co_lg_carto_trait_img1"> ArcGis </label>
                                                </div>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="co_lg_carto_trait_img2" name="co_lg_carto_trait_img" class="custom-control-input" value="5">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="co_lg_carto_trait_img3" name="co_lg_carto_trait_img" class="custom-control-input"value="2">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="trav_carto_realise0" name="trav_carto_realise" class="custom-control-input"value="0"required>
                                                    <label class="custom-control-label" for="trav_carto_realise0"> Aucun Travail </label>
                                                </div>

                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="trav_carto_realise1" name="trav_carto_realise" class="custom-control-input"value="5"required>
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="trav_carto_realise3" name="trav_carto_realise" class="custom-control-input"value="5">
                                                    <label class="custom-control-label" for="trav_carto_realise3">Participation au travaux cartographique à l'IGN</label>
                                                </div>

                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="trav_carto_realise4" name="trav_carto_realise" class="custom-control-input"value="3">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <label class="font-weight-bold">Age : </label>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="age18" name="age18" class="custom-control-input" value="0" <?php if($age < 18) echo " checked"; ?> required />
                                                    <label class="custom-control-label" for="age18"> Moins de 18 ans </label>
                                                </div>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="age18-3" name="age18" class="custom-control-input" value="3" <?php if($age > 55) echo " checked"; ?> />
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="dp_chauffeur18" name="dp_chauffeur18" class="custom-control-input" value="5" required>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="exp_chauffeur18" name="exp_chauffeur18" class="custom-control-input"  value="3" required>
                                                    <label class="custom-control-label" for="exp_chauffeur18">Obtenu avant 2010 </label>
                                                </div>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="exp_chauffeur18_1" name="exp_chauffeur18" class="custom-control-input"  value="2" required>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="occ_ant" name="occ_ant" class="custom-control-input" value="3"required>
                                                    <label class="custom-control-label" for="occ_ant"> Chauffeur en entreprise </label>
                                                </div>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="occ_ant_1" name="occ_ant" class="custom-control-input"value="2">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="nb_langue18" name="nb_langue18" class="custom-control-input"value="1"required>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="age171" name="age17" class="custom-control-input" value="0" <?php if($age < 18) echo " checked"; ?> required/>
                                                    <label class="custom-control-label" for="age171"> Moins de 18 ans </label>
                                                </div>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="age17-2" name="age17" class="custom-control-input" value="2" <?php if($age > 18 && $age <= 45) echo " checked"; ?> />
                                                    <label class="custom-control-label" for="age17-2">18-45 ans</label>
                                                </div>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="age17-5" name="age17" class="custom-control-input" value="1" <?php if($age > 45) echo " checked"; ?> />
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <label class="font-weight-bold">Diplôme : </label>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="dp_collect17_6" name="dp_collect17" class="custom-control-input" value="0" required/>
                                                    <label class="custom-control-label" for="dp_collect17_6"> Non Conforme </label>
                                                </div>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="dp_collect17-1" name="dp_collect17" class="custom-control-input" value="0">
                                                    <label class="custom-control-label" for="dp_collect17-1">Moins de BAC + 2</label>
                                                </div>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="dp_collect17-2" name="dp_collect17" class="custom-control-input" value="3">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="exp_collect17-1" name="exp_collect17" class="custom-control-input" value="0"required>
                                                    <label class="custom-control-label" for="exp_collect17-1"> Aucune enquête statistique </label>
                                                </div>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="exp_collect17-2" name="exp_collect17" class="custom-control-input" value="2">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="utilis_tablette-1" name="utilis_tablette" class="custom-control-input"value="3"required>
                                                    <label class="custom-control-label" for="utilis_tablette-1">Expérience en utilisation CAPI</label>
                                                </div>
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="utilis_tablette-2" name="utilis_tablette" class="custom-control-input" value="0">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="cons_informatique-1" name="cons_informatique" class="custom-control-input" value="5" required>
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="cons_informatique-3" name="cons_informatique" class="custom-control-input" value="0">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="nb_langue17" name="nb_langue17" class="custom-control-input"  value="1"required>
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="nb_langue17_2" name="nb_langue17" class="custom-control-input"  value="6">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="dispoP" name="dispo" class="custom-control-input" value="0" required/>
                                                ...
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="dispo2" name="dispo" class="custom-control-input"  value="0">
