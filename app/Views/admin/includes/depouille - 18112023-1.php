            ...
            <?php foreach ($person as $key => $value):?>
                ...
                <div class="row border-bottom">
                    ...
                    <div class="col-3">
                        ...
                        <div class="row mb-1"> <div class="col font-weight-bold"> Age </div> <div class="col"> <?= intval(date('Y')) - intval(substr($value->date_naiss, -4)) ?> ans </div> </div>                  
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <?php if(!empty($value->cv)){?>  
                                                <div class="custom-control custom-control-inline custom-checkbox mt-2">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="age122" name="age12" class="custom-control-input" value="3" />
                                                    <label class="custom-control-label" for="age122"> 18-39 ans </label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="age123" name="age12" class="custom-control-input" value="2" />
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="co_lg_carto_trait_img" class="custom-control-input"value="3">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="age18-1" name="age18" class="custom-control-input" value="3" />
                                                    <label class="custom-control-label" for="age18-1"> 18-34 ans </label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="age18-2" name="age18" class="custom-control-input" value="3" />
                                                    <label class="custom-control-label" for="age18-2"> 35-55 ans </label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="age18-3" name="age18" class="custom-control-input" value="0" />
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="age17-2" name="age17" class="custom-control-input" value="3" />
                                                    <label class="custom-control-label" for="age17-2"> 18-29 ans </label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="age17-3" name="age17" class="custom-control-input" value="2" />
                                                    <label class="custom-control-label" for="age17-3"> 30-39 ans </label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="age17-4" name="age17" class="custom-control-input" value="1" />
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    ...
                                                    <label class="custom-control-label" for="age171-6"> Pas Conforme </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    ...
                                                    <label class="custom-control-label" for="dp_collect17_6"> Pas Conforme </label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="utilis_tabletteP" name="utilis_tablette" class="custom-control-input" value="0" />
                                                    <label class="custom-control-label" for="utilis_tabletteP"> Pas Conforme </label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="cons_informatiqueP" name="cons_informatique" class="custom-control-input" value="0" />
                                                    <label class="custom-control-label" for="cons_informatiqueP"> Pas Conforme </label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="nb_langue17P" name="nb_langue17" class="custom-control-input" value="0" />
                                                    <label class="custom-control-label" for="nb_langue17P"> Pas Conforme </label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="residenceP" name="residence" class="custom-control-input" value="0" />
                                                    <label class="custom-control-label" for="residenceP"> Pas Conforme </label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    ...
                                                    <label class="custom-control-label" for="dispoP"> Pas Conforme </label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                        ...
                        <div class="row my-3"> <div class="col text-center"> <button class="btn btn-primary">Valider le depouillement</button> </div> </div>
                    </div>
