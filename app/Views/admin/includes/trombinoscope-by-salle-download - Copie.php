            ...
            <div class="col-12 mt-3"> 
                <?php foreach ($person as $key => $value):?>
                    <div class="row border-bottom">
                        ...
                        <div class="col-4">
                            <div class="row mb-1"> <div class="col font-weight-bold"> N° </div> <div class="col"> <?= $value->matricule ?> </div> </div>
                        ...
                        <div class="col-2">
                            <!-- <div class="row mb-1"> <div class="col"> <?= $value->comSalle ?> </div> </div>
                            <div class="row mb-1"> <div class="col"> <?= $value->quartSalle ?> </div> </div>
                            <div class="row mb-1"> <div class="col"> <?= $value->adresSalle ?> </div> </div> -->
                            <div class="row mb-1"> <div class="col"> <?= $value->siteSalle ?> </div> </div>
                            <div class="row mb-1"> <div class="col"> <?= $value->salle ?> </div> </div>
                        </div>    
