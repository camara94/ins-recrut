...
<div class="row py-3">
    <div class="col-sm-4 order-1 order-sm-2">
                    ...
                    <?php if($data['is_admited'] == 1): ?>
                        <div class="row">
                            <div class="col-xs-12 text-center text-success"> 
                                ...
                                <?= $title ?> <?= strtoupper($data['last_name']); ?>! <br> vous êtes admis<?= $sexe_ac ?> au poste 
                    ...
                    <?php else: ?>
                        <div class="row">
                            <div class="col-xs-12 text-center text-danger"> 
                                <h3 class="h1"> <strong>Desolé</strong> <?= $title ?> <?= strtoupper($data['last_name']); ?>! <br> Désolé, votre candidature n'a pas été acceptée veillez vous préparez pour la prochaine candidature </h3> 
                            </div>    
                        </div>                           
                    <?php endif; ?>
                </div>
        ...
        <?php else: ?>
            <div class="row"> 
                <div class="col-xs-12 text-center text-danger"> 
                    <h3 class="h2">Désolé, votre candidature n'a pas été acceptée veillez vous préparez pour la prochaine candidature <br> (matricule, numéro de telephone ou email) </h3> 
                </div>              
            </div>              
            <div class="row"> 
                <div class="col-xs-12 text-center"> 
