...
<form class="paymentWrap container-fluid" id="frmRegister" method="post" action="/mregister" enctype="multipart/form-data">
    <div class="row py-3">
                    ...
                    <div class="card-body">
                        ...
                        <?php  
                            ...
                            <div class="my-2">
                                ...
                                <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked1" name="lucontrat" value="1" checked />
                                <label class="form-check-label" for="flexSwitchCheckChecked1">J'ai lu l'avis et je comprends</label>
                                </div>
                        ...
                        <p class="card-text">
                            ...
                            <div class="my-2">
                                <div class="form-outline">
                                    <input type="text" id="surname_postulant" name="surname_postulant" class="form-control"  />
                            ...
                            <div class="my-2">
                                <div class="form-outline">
                                <input type="text" id="nom" name="name_postulant" class="form-control"  />
                            ...
                            <div class="my-2 p-2">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="sex" id="radioSexe1" value="1" checked />
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <div class="my-2">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="radioPhone1" name="possedeNumTel" value="1"  />
                            ...
                            <div class="my-2 div-phone">
                                <div class="form-outline">
                                    <input type="tel" id="contact_1" name="contact_1"  class="form-control" />
                ...
                <div class="card border border-start-0 border-bottom-0 mt-2">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <div class="my-2">
                                <div class="form-outline">
                                    <input type="text" id="namepere" name="namepere" class="form-control"  />
                            ...
                            <div class="my-2">
                                <div class="form-outline">
                                <input type="text" id="namemere" name="namemere" class="form-control"  />
                ...
                <div class="card border border-start-0 border-bottom-0 mt-2">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <div class="my-2">
                                <div class="form-outline">
                                    <input type="text" id="nametuteurlegal" name="nametuteurlegal" class="form-control"  />
                            ...
                            <div class="my-2">
                                <div class="form-outline">
                                <input type="tel" id="contact_2" name="contact_2" class="form-control"  />
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <div class="my-2">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="radioDisponible1" name="pdispo" value="1"  />
                            ...
                            <div class="my-2 p-2 div-disponibilite">
                                <input class="form-check-input" type="checkbox" id="confirmdispo" name="confirmdispo" value="1" />
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <div class="my-2">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineCheckboxc1" name="hasexpcollecte" value="1"  />
                ...
                <div class="card border border-start-0 border-bottom-0  mt-2">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <div class="my-2">
                                <div class="form-outline">
                                <input type="text" id="dateSignature" name="date_jour_decla" class="form-control"  />
