...
<div style="width:645px; margin:auto; margin-top:60px; padding-top:10px; padding-bottom:20px;background-color:#f1f1f1; margin-bottom:20px">
  <div class="center-text top-10 bottom-10"><span style="color:red">(*)</span> Il s'agit de votre période de disponibilité entière et totale sur la période du RGPH-4 (01/11/2023 au 30/04/2024);</div>
    <div style="width: 500px; margin-left: 52px; margin-right: 52px">
        <div id="div_second_pers">
           <!--
            <div class="form-group">
...
<div style="width:645px; margin:auto; margin-top:5px; padding-top:10px; padding-bottom:20px;background-color:#f1f1f1; margin-bottom:20px">
    <div style="width: 500px; margin-left: 52px; margin-right: 52px">
        <div id="div_second_pers">
            ...
            <div class="form-group">
                <label for="inputPassword3" class="col-sm-4 control-label text-bold">JOINDRE CNI / ATTESTATION / PASSPORT / CARTE D'ELECTEUR
            ...
            <div class="form-group">
                <label for="inputPassword3" class="col-sm-4 control-label text-bold">NUMERO DE LA CNI / ATTESTATION / PASSPORT / CARTE D'ELECTEUR<span style="color:red">(*)</span></label>
                <div class="col-sm-8">
            ...
            <div class="form-group">
                <label for="inputPassword3" class="col-sm-4 control-label text-bold">JOINDRE CNI / ATTESTATION / PASSPORT / CARTE D'ELECTEUR DE LA 1ERE PERSONNE A CONTACTER 
                    <span style="font-weight:500;"> Taille Maxi 2Mo en <span style="color:red;">jpeg,png,jpg,pdf </span> (<span style="color:red;">*</span>)</span></label>
                <div class="col-sm-8">
