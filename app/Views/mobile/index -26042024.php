                ...
                <div class="card border border-0  mt-2">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <div class="my-2">
                                <div class="form-outline <?php if($projet_id == 18){ echo" hidden"; } ?>">
                            ...
                            <div class="my-2">
                                <label for="userFiles3" class="form-label">
                                    <?php
                                        ...
                                        else{echo"Joindre le Diplôme plus haut / Attestation de Reussite";}
                                    ?>
                                </label>
                                <input class="form-control form-control-sm" name="userFiles3" id="userFiles3" type="file" required />
                            </div> 
                            <div class="my-2 <?php if($projet_id == 18){ echo" d-none"; } ?>">
                                <label for="userFiles2" class="form-label">Joindre Curriculum Vitae </label>
                                <input class="form-control form-control-sm" id="userFiles2" name="userFiles2" type="file" <?php // if($id_projet_id != 18){ echo" required"; } ?> />
                            </div> 
                            <div class="my-2">
    ...
    $(document).ready(function(){ 
        ...
        $(".btn-next-block3").click(function(e){e.preventDefault();  
            ...
            if($("#userFiles1").val().length > 0 && $("#surname_postulant").val().length > 0 && $("#nom").val().length > 0 &&
                ...
                $("#contact_2").val().length ==9 && $("#contact_22").val().length ==9) 
             { appendAlert('', '');
