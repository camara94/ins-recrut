            ...
            <div class="row">
                <div class="col-12">  
                    ...
                    <table class="table table-sm">
                        <tbody>
                            <tr> <th scope="row">NUMERO D'INSCRIPTION </th> <td class="tableMatricule"> <?= strtoupper($data['matricule']) ?> </td></tr>  
                            ...
                            <tr> <th scope="row">COMMUNE / SP</th> <td class="tableLieuNaissance"> <?= strtoupper(@$data['departement3']['NomDep'])." - ".strtoupper(@$data['sousprefecture3']['NomSp']) ?> </td> </tr>
                            <tr> 
