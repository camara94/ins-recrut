    ...
    <div class="offset-sm-4 col-sm-4">
        ...
        <section class="section-block2 container" id="pimprime">
            <?php if($hasExiste == true): ?>                
                <?php if($data['id_projet'] != 18): ?>                
                            ...
                            <?php if($data['is_admited'] == 1 && $data['rank'] > 0): ?>
                                <div class="row">
                                    <div class="col-xs-12 text-center text-success"> 
                                        <h6 class="h6">  
                                            <div> <strong>Félicitation</strong>, vous êtes retenus comme agent de terrain pour la réalisation de la cartographie censitaire du RGPH-4.</div>
                                            ...
                                            <!-- <?= $title ?> <?= strtoupper($data['last_name']); ?>! <br> 
                                            vous êtes admis<?= $sexe_ac ?> pour la Cartographie comme :  
                                            <strong><?= ucfirst(strtolower($data['NomProjet'])); ?></strong>.  -->
                                        </h6> 
                                    </div>    
                                </div>
                            <?php else: ?>
                                <div class="row">
                                    <div class="col-xs-12 text-center text-danger"> 
                                        ...
                                        <h6 class="h6"> <strong>Desolé, </strong> 
                                            vous n'avez pas été retenu comme agent de collecte des données pour la cartographie. 
                                            En cas de besoin, vous serez contacté par les services des ressources humaines.
                                        </h6> 
                                    </div>    
                                </div>                           
                            <?php endif; ?>
                    ...
                    <div class="top-30 row">
                        <div class="col-sm-7">
                            <div class="row">
                                <div class="col-5"> <h6 class="h6">Matricule</h6> </div>
                                <div class="col-7"> <h6 class="h6"> <?= strtoupper($data['matricule']); ?> </h6> </div>    
                            </div>

                            <div class="row">
                                <div class="col-5"> <h6 class="h6">Prénom (s)</h6> </div>
                                <div class="col-7"> <h6 class="h6"> <?= strtoupper($data['name']); ?> </h6> </div>    
                            </div>

                            <div class="row">
                                <div class="col-5"> <h6 class="h6">Nom de Famille</h6> </div>
                                <div class="col-7"> <h6 class="h6"> <?= strtoupper($data['last_name']); ?> </h6> </div>    
                            </div>

                            <div class="row">
                                <div class="col-5"> <h6 class="h6">Téléphone</h6> </div>
                                <div class="col-7"> <h6 class="h6"> <?= $data['contact1']; ?> </h6> </div>    
                            </div>

                            <div class="row">
                                <div class="col-5"> <h6 class="h6">Email</h6> </div>
                                <div class="col-7"> <h6 class="h6"> <?= strtolower($data['email']); ?> </h6> </div>    
                            </div>

                            <div class="row">
                                <div class="col-5"> <h6 class="h6">N° Pièce</h6> </div>
                                <div class="col-7"> <h6 class="h6"> <?= strtoupper($data['numero_cni']); ?> </h6> </div>    
                            </div>
                            ...
                            <h6 class="h6 text-center text-bold text-danger">
                                ...
                                <?php if($data['is_admited'] == 1 && $data['rank'] > 0): ?> 
                                    <?php if($data['id_projet'] == 17): ?>
                                        ...
                                        <h3 class="text-center text-danger">Centre de Formation</h3>
                                        ...
                                        les candidats admis après formation, la date de lancement de la cartographie censitaire 
                                        sur le territoire national vous sera communiqué ultérieurement et vous êtes priés de 
                                        rester mobilisés à Conakry.
                                        </p>
            ...
            <?php else: ?>
                <div class="row"> 
                    <div class="col-xs-12 text-center text-danger"> 
                        <h6 class="h2">Votre candidature n'a pas été retrouvée, veillez verifier votre coordonnée <br> (matricule, numéro de telephone ou email) </h6> 
                    </div>              
                </div>              
                <div class="row"> 
                    <div class="col-xs-12 text-center"> 
                        <h6> <a href="<?= url_to('mcheckapp'); ?>" class=""> <i class="fa fa-undo"></i> Réessayez </a> </h6> 
                    </div>              
                </div>              
            <?php endif; ?> 
