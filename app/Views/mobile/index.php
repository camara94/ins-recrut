    ...
    <div class="row py-3">
        <div class="col-12">
            <section class="section-block1 section"> 
                ...
                <div class="card border border-0">
                    <div class="card-body">
                        ...
                        <?php  
                            $projet_id= (isset($_POST['choix_projet'])? intval($_POST['choix_projet']): 0); //17
                            if($projet_id==12){ 
                                // TECHNICIEN LABORATOIRE CARTOGRAPHIE
                                echo $this->include('avis/avimobile1.php'); 
                            }
                            else if($projet_id == 17){ 
                            ...
                            else if($projet_id == 18){ 
                                echo $this->include('avis/avis18.php'); 
                            }
                            else if($projet_id == 19){ 
                                echo $this->include('avis/avismobile19.php'); 
                            }
                            else if($projet_id == 20){ 
                                echo $this->include('avis/avismobile20.php'); 
                            }
                        ...
                        <div class="my-2">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="checkboxContract">J'ai lu l'avis et je comprends</label>
                            </div>                                
                        </div>
            ...
            <section class="section-block2 section">
                ...
                <div class="card border border-0  mt-2">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="my-2 d-none">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radioPhone1" checked="checked" name="possedeNumTel" value="1" required />
                                        <label class="form-check-label" for="radioPhone1">Oui</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="radioPhone2"  name="possedeNumTel" value="2" />
                                        <label class="form-check-label" for="radioPhone2">Non</label>
                                    </div>                                
                                </div>                            
                            </div> <!-- end  col-sm-6  div-phone -->
                            <div class="col-sm-4">
                                <div class="my-2">
                                    <div class="form-outline">
                                        <input type="tel" id="contact_1" name="contact_1" required class="form-control"  minlength="9"  maxlength="9s" />
                            ...
                            <div class="col-sm-4">
                                <div class="my-2 ">
                                    <div class="form-outline">
                                        <input type="tel" id="phone_om" name="phone_om" required class="form-control"  minlength="9"  maxlength="9s" />
                                        <label class="form-label" for="contact_1"> Numéro Orange Money</label>                                   
                                    </div>
                                    <div class="form-text"> 
                                        Exemple 600000000
                                    </div>
                                    <div class="form-text text-muted text-"> 
                                        <input type="checkbox" name="confirmOM" id="confirmOM" value="1" required /> 
                                        Je confirme que ce numéro Orange Money est le mien <span style="color:red">(*)</span>
                                    </div>
                                </div>                           
                            </div> <!-- end  col-sm-4 -->
                        </div> <!-- end  row -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="my-2">
                                    <div class="form-outline">
                                    <input type="tel" id="contact_2" name="contact_2" class="form-control" minlength="9"  maxlength="9s" />
                            ...
                            <div class="col-sm-3">
                                <div class="my-2">
                                    <div class="form-outline">
                                    <input type="tel" id="contact_22" name="contact_22" class="form-control" minlength="9"  maxlength="9s" />
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <div class="text-muted">
                                (*) Il s'agit de votre disponibilité entière et totale sur une durée minimale de 6 mois de façon continue sur le RGPH-4
                            </div>
                            <div class="my-2">
                ...
                <div class="card border border-0 mt-2">
                    <div class="card-body">
                            ...
                            <div class="col-sm-10">
                                <div class="my-2">
                                    <select class="select"  id="type_piece" name="type_piece">
                                        ...
                                        <option value="permis">CARTE ELECTEUR</option>
                                    </select>                                      
                                </div> 
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="my-2">
                                    ...
                                    <div class="form-text"> 
                                        Carte D'identite/Attestation/Passport/Carte Electeur
                                    </div>
                                </div> 
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-10">
                                ...
                                <div class="my-2">
                                    ...
                                    <label class="form-label" for="numero_cni">Numéro de la Pièce D'identité(*)</label>
                                    </div>
                                    <div class="form-text"> 
                                    Carte D'identite/Attestation/Passport/Carte Electeur
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="my-2">
                                    <label for="formFileSm" class="form-label">Joindre Le Fichier De La 1ere Personne à Contacter </label>
            ...
            <section class="section-block3 section">
                ...
                <div class="card border border-0  mt-2">
                    <div class="card-body">
                    <h5 class="card-title"><b><i class="fas fa-info"></i>Code de Bonne Conduite</b></h5>                     
            ...
            <section class="section-block4 section">
                <!-- start block 4 -->
                <h5 class=""><b><i class="fas fa-info"></i>Informations Complementaires</b></h5>
                <div class="card border border-0 mt-2 <?php if($id_projet == 18){ echo" d-none"; } ?>">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="my-2">
                                    <div class="form-outline">
                                        <input type="email" id="email" name="email" class="form-control" <?php if($id_projet != 18){ echo" required"; } ?>/>
                ...
                <div class="card border border-0  mt-2">
                    ...
                    <?php
						...
						if($projet_id==18){
                            ...
                            $labelOption = "NIVEAU D'ETUDE";
                        }                
                        $status = array(
                            '' => "Selectionnez votre Statut (*)",                            
                            'ETUDIANT / ELEVE' => "ETUDIANT / ELEVE",
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-3">
                                ...
                                <div class="my-2">
                                    <div class="form-outline <?php if($projet_id == 18 ||$projet_id == 19){ echo" d-none"; } ?>">
                                        <input type="text" id="last_diplome" name="last_diplome"  class="form-control"  />
                ...
                <div class="card border border-0  mt-2">
                    <div class="card-body">
                        <h5 class="card-title"><b><i class="fa fa-info-circle" aria-hidden="true"></i>
                        <?php 
                            if($projet_id == 18){ echo "Experience en tant que Chauffeur"; }
                            else{ echo"Dernière Experience en Collecte de Données"; }
                        ?> 
                        </b></h5>
                        <p class="card-text">
                            <div class="my-2">
                                <label class="form-check-label" for="flexSwitchCheckChecked1">
                                    <?php 
                                        if($projet_id==18) echo "Avez vous une expérience en tant que chauffeur ?"; 
                                        else echo"Avez vous une expérience en collecte de données ?";
                                    ?>
                                </label><br>
                                <div class="form-check form-check-inline">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineCheckboxc2"  name="hasexpcollecte" value="2" checked />
                            ...
                            <?php if($projet_id == 18){ ?>
                                <div class="my-2 div-experience">
                                    <label for="fontion_1">OCCUPATION</label>                                  
                                    <select name="fontion_1" id="fontion_1" class="select"> 
                                        <option value=""></option> 
                                        <option value="Chauffeur Taxi">Chauffeur Taxi</option> 
                                        <option value="Chauffeur Bus">Chauffeur Bus</option> 
                                        <option value="Chauffeur Patron">Chauffeur Particulier</option> 
                                    </select>
                                </div> 
                                <div class="my-2 div-experience">
                                <label for="fontion_1">STRUCTURE</label> 
                                <select name="projet_name_1" id="projet_name_1" class="select"> 
                                    <option value=""></option> 
                            ...
                            <?php 
                                ...
                                <div class="my-2 div-experience">
                                    <div class="form-outline">
                                        ...
                                        <label class="form-label" for="projet_name_1">Activités/Enquête</label>
                                    </div>
                                </div> 
                                <div class="my-2 div-experience">
                                    <div class="form-outline">
                ...
                <div class="card border border-0  mt-2">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="my-2">
                                    <select class="form-control select-ne-marche-pas" name="first_langue" id="first_langue" required> 
                ...
                <div class="card border border-0  mt-2">
                    <div class="card-body">
                        <h5 class="card-title"><b> <i class="fa fa-paperclip" aria-hidden="true"></i> Joindre </b></h5>
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="my-2">
                                    <label for="userFiles3" class="form-label">
                                    <?php
                                        if($projet_id == 18){ echo"JOINDRE LA COPIE DU PERMIS DE CONDUIRE"; }
                                        else if($projet_id == 19){ 
                                            echo"JOINDRE <br />"; 
                                            echo'<span style="font-weight:500;">&nbsp;&nbsp; Diplôme </span> <br />';
                                            echo'<span style="font-weight:500;">&nbsp;&nbsp; Attestation de Niveau </span> <br />';
                                            echo'<span style="font-weight:500;">&nbsp;&nbsp; Relevé de Note </span> <br />';
                                        }
                                        else{echo"JOINDRE DIPLOME LE PLUS HAUT / ATTESTATION DE REUSSITE";}
                                    ?>
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="my-2 <?php if($projet_id == 18 || $projet_id == 19){ echo" d-none"; } ?>">
                                    <label for="userFiles2" class="form-label">Joindre Curriculum Vitae </label>
                                    <input class="form-control form-control-sm" id="userFiles2" <?php if($projet_id != 19){ echo" required "; } ?>  name="userFiles2" type="file" <?php // if($id_projet_id != 18){ echo" required"; } ?> />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="my-2 <?php if($projet_id == 18 || $projet_id == 19){ echo" d-none"; } ?>">
                                ...
                                <input class="form-control form-control-sm" id="userFiles6" name="userFiles6" type="file"  <?php if($projet_id != 19){ echo" required "; } ?> />
                            </div> 
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="my-2">                                                             
                                    <select name="departement3" id="selectDep" class="form-control">
                                        <option class="optElem0" value="0">
                                        <!--    Selectionner une Préfecture -->

                                            <?php if($projet_id == 19):?>
                                                PREFECTURE DE TRAVAIL SOUHAITÉ
                                            <?php else:?>  
                                                PREFECTURE DE RESIDENCE ACTUELLE
                                            <?php endif;?>

                                            (*)
                                        </option>
                                        <?php foreach ($listDep as $key => $list):?>
                                            <option value="<?= $list['CodDep'] ?>" class="optElem<?php echo $list['NomDep'] ?>"> <?= strtoupper($list['NomDep'])?> </option>
                                        <?php endforeach;?>  
                                    </select>
                                </div>  
                            </div>
                                ...
                                <div class="my-2">
                                    <select name="sousprefecture3" id="selectSP" class="form-control" required>
                                        <option class="optElem0" value="0">
                                           ...
                                           <!-- Selectionner une Sous-Préfecture -->
                                            <?php if($projet['id'] == 19):?>
                                                SOUS-PREFECTURE DE TRAVAIL SOUHAITÉ
                                            <?php else:?>  
                                                SOUS-PREFECTURE DE RESIDENCE ACTUELLE 
                                            <?php endif;?>
                                             (*)</option>
                                        <?php foreach ($listSP as $key => $list):?>
                                            <option value="<?= $list['CodSp'] ?>" class="optElem<?= $list['CodDep'] ?>"> <?= strtoupper($list['NomSp']) ?> </option>
                                        <?php endforeach;?>  
                                    </select>
                                </div> 
                            </div>
                            <div class="col-sm-4"> 
                                ...
                                <div class="my-2">
                                    <label class="form-check-label" for=""> Residence Situation ? (*) </label><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="residence_situation" id="residence_situation1" autocomplete="off" value="1" checked required> 
                                        <label class="form-check-label" for="residence_situation1">Resident de la Sous-préfecture ou Commune de <b class="lbl_sr_sprefect"> ______ </b></label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="residence_situation" id="residence_situation2" autocomplete="off" value="2"> 
                                        <label class="form-check-label" for="residence_situation2">Ressortissant de la Sous-préfecture ou Commune de <b class="lbl_sr_sprefect"> ______ </b></label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="residence_situation" id="residence_situation3" autocomplete="off" value="3"> 
                                        <label class="form-check-label" for="residence_situation3"> Resident de la Préfecture <b class="lbl_sr_prefect"> __ </b>. </label>
                                    </div>
                                </div>                             
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="my-2">
                                    <div class="form-outline">
                                        <input type="date" id="dateSignature" name="date_jour_decla" class="form-control" required />
                ...
                <div class="card border border-0  mt-2">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <div class="my-2">
                                <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked1" value="Terrain" name="val_model1" />
                                <label class="form-check-label" for="flexSwitchCheckChecked1">Je confirme ma disponibilité et j'atteste la véracité des informations fournies</label>
                                </div>
                            </div> 
                        </p>
                    </div>
...
<script type="text/javascript">  
    $(document).ready(function(){ 
        ...
        $(".btn-next-block3").click(function(e){e.preventDefault();  
            ...
            if($("#userFiles1").val().length > 0 && $("#surname_postulant").val().length > 0 && $("#nom").val().length > 0 &&
                $("#date_naiss").val().length > 0 && $("#lieu_naissance").val().length > 0 && $("#type_piece").val().length > 0 
                    && $("#formFileSm").val().length > 0 && $("#numero_cni").val().length > 0 && $("#userFiles5").val().length > 0
                    && $("#confirmdispo").is(':checked') && $("#contact_1").val().length ==9 && 
                $("#contact_2").val().length ==9 && $("#contact_22").val().length ==9 && $("#confirmOM").is(':checked')) 
             { appendAlert('', '');
        ...
        $(".btn-next-block5").click(function(e){e.preventDefault();  
            if($("#niveau_etude").val().length > 0  && $("#status").val().length > 0
                && $("#first_langue").val().length > 0 ){ appendAlert('', '');
        ...
        $(".btn-next-block6").click(function(e){e.preventDefault(); 
            if($("#selectDep").val().length > 0 && $("#selectSP").val().length > 0  && $("#dateSignature").val().length > 0 && $("#acceptDeclaration5").is(':checked')){ appendAlert('', '');
                ...
                $(".tableSexe").text(($("#radioSexe1").is(':checked')) ? "Homme" : "Femme");
                ...
                $(".tablePremierLang").text($("#first_langue option[value='"+$("#first_langue").val()+"']").text());
                $(".tableSecondLang").text($("#second_langue option[value='"+$("#second_langue").val()+"']").text());
                // $(".tableSecondLang").text($("#second_langue").val());
                $(".tableNiv").text($("#niveau_etude option[value='"+$("#niveau_etude").val()+"']").text());              
        ...
        $("#selectDep").change(function(){$idElem=$(this).val(); 
            ...
            $(".lbl_sr_prefect").html($('#selectDep option:selected').text());
        })

        $("#selectSP").change(function(){$idElem=$(this).val(); 
            $(".lbl_sr_sprefect").html($('#selectSP option:selected').text());
        })
